...
internal interface UniffiCallbackInterfaceVoidCallbackMethod0: com.sun.jna.Callback {
    fun callback(`uniffiHandle`: Long,`proxyPort`: Short,`frontendPort`: Short,`uniffiOutReturn`: Pointer,uniffiCallStatus: UniffiRustCallStatus,)
}
@Structure.FieldOrder("callback", "uniffiFree")
internal open class UniffiVTableCallbackInterfaceVoidCallbackStruct(
    @JvmField internal var `callback`: UniffiCallbackInterfaceVoidCallbackMethod0?,
    ...
    ): UniffiVTableCallbackInterfaceVoidCallback(`callback`,`uniffiFree`,), Structure.ByValue
}

internal typealias UniffiVTableCallbackInterfaceVoidCallback = UniffiVTableCallbackInterfaceVoidCallbackStruct
...
internal typealias UniffiVTableCallbackInterfaceVoidCallbackUniffiByValue = UniffiVTableCallbackInterfaceVoidCallbackStruct.UniffiByValue
...
internal interface UniffiLib : Library {
    companion object {
        internal val INSTANCE: UniffiLib by lazy {
            loadIndirect<UniffiLib>(componentName = "reverse_proxy")
                .also { lib: UniffiLib ->
...
private fun uniffiCheckContractApiVersion(lib: UniffiLib) {
    ...
    val scaffolding_contract_version = lib.ffi_reverse_proxy_uniffi_contract_version()
...
private fun uniffiCheckApiChecksums(lib: UniffiLib) {
    if (lib.uniffi_reverse_proxy_checksum_func_forward() != 252.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_reverse_proxy_checksum_func_start() != 46008.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_reverse_proxy_checksum_method_voidcallback_callback() != 21414.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
}
...
internal object uniffiCallbackInterfaceVoidCallback {
    internal object `callback`: UniffiCallbackInterfaceVoidCallbackMethod0 {
    ...
    internal val vtable = UniffiVTableCallbackInterfaceVoidCallback(
        `callback`,
        uniffiFree,
    )

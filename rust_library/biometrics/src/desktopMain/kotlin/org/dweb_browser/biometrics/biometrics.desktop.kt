...
package org.dweb_browser.biometrics
...
internal object RustBufferHelper {
    fun allocValue(size: ULong = 0UL): RustBufferByValue = uniffiRustCall { status ->
        ...
        UniffiLib.INSTANCE.ffi_biometrics_rustbuffer_alloc(size.toLong(), status)
    }.also {
        if(it.data == null) {
    ...
    fun free(buf: RustBufferByValue) = uniffiRustCall { status ->
        UniffiLib.INSTANCE.ffi_biometrics_rustbuffer_free(buf, status)
    }
}
...
internal interface UniffiLib : Library {
    companion object {
        internal val INSTANCE: UniffiLib by lazy {
            loadIndirect<UniffiLib>(componentName = "biometrics")
                .also { lib: UniffiLib ->
    ...
    fun uniffi_biometrics_fn_func_biometrics_result_content(
        `reason`: RustBufferByValue,
        uniffiCallStatus: UniffiRustCallStatus,
    ): RustBufferByValue
    fun uniffi_biometrics_fn_func_check_support_biometrics(
        uniffiCallStatus: UniffiRustCallStatus,
    ): Byte
    fun ffi_biometrics_rustbuffer_alloc(
        `size`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): RustBufferByValue
    fun ffi_biometrics_rustbuffer_from_bytes(
        `bytes`: ForeignBytesByValue,
        uniffiCallStatus: UniffiRustCallStatus,
    ): RustBufferByValue
    fun ffi_biometrics_rustbuffer_free(
        `buf`: RustBufferByValue,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Unit
    fun ffi_biometrics_rustbuffer_reserve(
        `buf`: RustBufferByValue,
        `additional`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): RustBufferByValue
    fun ffi_biometrics_rust_future_poll_u8(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_cancel_u8(
        `handle`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_free_u8(
        `handle`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_complete_u8(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Byte
    fun ffi_biometrics_rust_future_poll_i8(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_cancel_i8(
        `handle`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_free_i8(
        `handle`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_complete_i8(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Byte
    fun ffi_biometrics_rust_future_poll_u16(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_cancel_u16(
        `handle`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_free_u16(
        `handle`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_complete_u16(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Short
    fun ffi_biometrics_rust_future_poll_i16(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_cancel_i16(
        `handle`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_free_i16(
        `handle`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_complete_i16(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Short
    fun ffi_biometrics_rust_future_poll_u32(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_cancel_u32(
        `handle`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_free_u32(
        `handle`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_complete_u32(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Int
    fun ffi_biometrics_rust_future_poll_i32(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_cancel_i32(
        `handle`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_free_i32(
        `handle`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_complete_i32(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Int
    fun ffi_biometrics_rust_future_poll_u64(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_cancel_u64(
        `handle`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_free_u64(
        `handle`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_complete_u64(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Long
    fun ffi_biometrics_rust_future_poll_i64(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_cancel_i64(
        `handle`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_free_i64(
        `handle`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_complete_i64(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Long
    fun ffi_biometrics_rust_future_poll_f32(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_cancel_f32(
        `handle`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_free_f32(
        `handle`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_complete_f32(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Float
    fun ffi_biometrics_rust_future_poll_f64(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_cancel_f64(
        `handle`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_free_f64(
        `handle`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_complete_f64(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Double
    fun ffi_biometrics_rust_future_poll_pointer(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_cancel_pointer(
        `handle`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_free_pointer(
        `handle`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_complete_pointer(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Pointer?
    fun ffi_biometrics_rust_future_poll_rust_buffer(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_cancel_rust_buffer(
        `handle`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_free_rust_buffer(
        `handle`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_complete_rust_buffer(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): RustBufferByValue
    fun ffi_biometrics_rust_future_poll_void(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_cancel_void(
        `handle`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_free_void(
        `handle`: Long,
    ): Unit
    fun ffi_biometrics_rust_future_complete_void(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Unit
    fun uniffi_biometrics_checksum_func_biometrics_result_content(
    ): Short
    fun uniffi_biometrics_checksum_func_check_support_biometrics(
    ): Short
    fun ffi_biometrics_uniffi_contract_version(
    ): Int
...
private fun uniffiCheckContractApiVersion(lib: UniffiLib) {
    ...
    val scaffolding_contract_version = lib.ffi_biometrics_uniffi_contract_version()
...
private fun uniffiCheckApiChecksums(lib: UniffiLib) {
    if (lib.uniffi_biometrics_checksum_func_biometrics_result_content() != 25839.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_biometrics_checksum_func_check_support_biometrics() != 20607.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
}
...
object FfiConverterTypeBiometricsResult: FfiConverterRustBuffer<BiometricsResult> {
    override fun read(buf: ByteBuffer): BiometricsResult {
    ...
    override fun write(value: BiometricsResult, buf: ByteBuffer) {
...
actual fun `biometricsResultContent`(`reason`: kotlin.String): BiometricsResult {
    return FfiConverterTypeBiometricsResult.lift(uniffiRustCall { uniffiRustCallStatus ->
        UniffiLib.INSTANCE.uniffi_biometrics_fn_func_biometrics_result_content(
...
actual fun `checkSupportBiometrics`(): kotlin.Byte {
    return FfiConverterByte.lift(uniffiRustCall { uniffiRustCallStatus ->
        UniffiLib.INSTANCE.uniffi_biometrics_fn_func_check_support_biometrics(
            uniffiRustCallStatus,
        )
    })
}

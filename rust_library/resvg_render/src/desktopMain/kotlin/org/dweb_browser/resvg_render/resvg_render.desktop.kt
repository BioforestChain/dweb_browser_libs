...
internal interface UniffiLib : Library {
    companion object {
        internal val INSTANCE: UniffiLib by lazy {
            loadIndirect<UniffiLib>(componentName = "resvg_render")
                .also { lib: UniffiLib ->
...
private fun uniffiCheckContractApiVersion(lib: UniffiLib) {
    ...
    val scaffolding_contract_version = lib.ffi_resvg_render_uniffi_contract_version()
...
private fun uniffiCheckApiChecksums(lib: UniffiLib) {
    if (lib.uniffi_resvg_render_checksum_func_svg_to_png() != 51667.toShort()) {

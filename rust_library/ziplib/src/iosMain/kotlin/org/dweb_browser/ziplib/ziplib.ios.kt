...
internal object RustBufferHelper {
    fun allocValue(size: ULong = 0UL): RustBufferByValue = uniffiRustCall { status ->
        ...
        UniffiLib.INSTANCE.ffi_ziplib_rustbuffer_alloc(size.toLong(), status)
    }.also {
        if(it.data == null) {
    ...
    fun free(buf: RustBufferByValue) = uniffiRustCall { status ->
        UniffiLib.INSTANCE.ffi_ziplib_rustbuffer_free(buf, status)
    }
}

typealias RustBuffer = CPointer<ziplib.cinterop.RustBuffer>
...
typealias RustBufferByValue = CValue<ziplib.cinterop.RustBuffer>
fun RustBufferByValue(
    capacity: Long,
    len: Long,
    data: Pointer?,
): RustBufferByValue {
    return cValue<ziplib.cinterop.RustBuffer> {
 ...
 */
internal typealias RustBufferByReference = CPointer<ziplib.cinterop.RustBufferByReference>
...
internal fun RustBufferByReference.getValue(): RustBufferByValue
    = pointed.reinterpret<ziplib.cinterop.RustBuffer>().readValue()


internal typealias ForeignBytes = CPointer<ziplib.cinterop.ForeignBytes>
...
internal typealias ForeignBytesByValue = CValue<ziplib.cinterop.ForeignBytes>
...
internal typealias UniffiRustCallStatus = CPointer<ziplib.cinterop.UniffiRustCallStatus>
...
internal typealias UniffiRustCallStatusByValue = CValue<ziplib.cinterop.UniffiRustCallStatus>
fun UniffiRustCallStatusByValue(
    code: Byte,
    errorBuf: RustBufferByValue
): UniffiRustCallStatusByValue {
    return cValue<ziplib.cinterop.UniffiRustCallStatus> {
        this.code = code
...
internal object UniffiRustCallStatusHelper {
    fun allocValue() = cValue<ziplib.cinterop.UniffiRustCallStatus>()
    fun <U> withReference(
        block: (UniffiRustCallStatus) -> U
    ): U {
        return memScoped {
            val status = alloc<ziplib.cinterop.UniffiRustCallStatus>()
            block(status.ptr)
        }
    }
}
...
internal typealias UniffiRustFutureContinuationCallback = ziplib.cinterop.UniffiRustFutureContinuationCallback
internal typealias UniffiForeignFutureFree = ziplib.cinterop.UniffiForeignFutureFree
internal typealias UniffiCallbackInterfaceFree = ziplib.cinterop.UniffiCallbackInterfaceFree
internal typealias UniffiForeignFuture = CPointer<ziplib.cinterop.UniffiForeignFuture>
...
internal typealias UniffiForeignFutureUniffiByValue = CValue<ziplib.cinterop.UniffiForeignFuture>
fun UniffiForeignFutureUniffiByValue(
    `handle`: Long,
    `free`: UniffiForeignFutureFree?,
): UniffiForeignFutureUniffiByValue {
    return cValue<ziplib.cinterop.UniffiForeignFuture> {
        this.`handle` = `handle`
        this.`free` = `free`
    }
}
...
internal typealias UniffiForeignFutureStructU8 = CPointer<ziplib.cinterop.UniffiForeignFutureStructU8>
...
internal typealias UniffiForeignFutureStructU8UniffiByValue = CValue<ziplib.cinterop.UniffiForeignFutureStructU8>
fun UniffiForeignFutureStructU8UniffiByValue(
    ...
    return cValue<ziplib.cinterop.UniffiForeignFutureStructU8> {
...
internal typealias UniffiForeignFutureCompleteU8 = ziplib.cinterop.UniffiForeignFutureCompleteU8
internal typealias UniffiForeignFutureStructI8 = CPointer<ziplib.cinterop.UniffiForeignFutureStructI8>
...
internal typealias UniffiForeignFutureStructI8UniffiByValue = CValue<ziplib.cinterop.UniffiForeignFutureStructI8>
fun UniffiForeignFutureStructI8UniffiByValue(
    `returnValue`: Byte,
    `callStatus`: UniffiRustCallStatusByValue,
): UniffiForeignFutureStructI8UniffiByValue {
    return cValue<ziplib.cinterop.UniffiForeignFutureStructI8> {
        this.`returnValue` = `returnValue`
        `callStatus`.write(this.`callStatus`.rawPtr)
    }
}
...
internal typealias UniffiForeignFutureCompleteI8 = ziplib.cinterop.UniffiForeignFutureCompleteI8
internal typealias UniffiForeignFutureStructU16 = CPointer<ziplib.cinterop.UniffiForeignFutureStructU16>
...
internal typealias UniffiForeignFutureStructU16UniffiByValue = CValue<ziplib.cinterop.UniffiForeignFutureStructU16>
fun UniffiForeignFutureStructU16UniffiByValue(
    `returnValue`: Short,
    `callStatus`: UniffiRustCallStatusByValue,
): UniffiForeignFutureStructU16UniffiByValue {
    return cValue<ziplib.cinterop.UniffiForeignFutureStructU16> {
        this.`returnValue` = `returnValue`
        `callStatus`.write(this.`callStatus`.rawPtr)
    }
}
...
internal typealias UniffiForeignFutureCompleteU16 = ziplib.cinterop.UniffiForeignFutureCompleteU16
internal typealias UniffiForeignFutureStructI16 = CPointer<ziplib.cinterop.UniffiForeignFutureStructI16>
...
internal typealias UniffiForeignFutureStructI16UniffiByValue = CValue<ziplib.cinterop.UniffiForeignFutureStructI16>
fun UniffiForeignFutureStructI16UniffiByValue(
    `returnValue`: Short,
    `callStatus`: UniffiRustCallStatusByValue,
): UniffiForeignFutureStructI16UniffiByValue {
    return cValue<ziplib.cinterop.UniffiForeignFutureStructI16> {
        this.`returnValue` = `returnValue`
        `callStatus`.write(this.`callStatus`.rawPtr)
    }
}
...
internal typealias UniffiForeignFutureCompleteI16 = ziplib.cinterop.UniffiForeignFutureCompleteI16
internal typealias UniffiForeignFutureStructU32 = CPointer<ziplib.cinterop.UniffiForeignFutureStructU32>
...
internal typealias UniffiForeignFutureStructU32UniffiByValue = CValue<ziplib.cinterop.UniffiForeignFutureStructU32>
fun UniffiForeignFutureStructU32UniffiByValue(
    `returnValue`: Int,
    `callStatus`: UniffiRustCallStatusByValue,
): UniffiForeignFutureStructU32UniffiByValue {
    return cValue<ziplib.cinterop.UniffiForeignFutureStructU32> {
        this.`returnValue` = `returnValue`
        `callStatus`.write(this.`callStatus`.rawPtr)
    }
}
...
internal typealias UniffiForeignFutureCompleteU32 = ziplib.cinterop.UniffiForeignFutureCompleteU32
internal typealias UniffiForeignFutureStructI32 = CPointer<ziplib.cinterop.UniffiForeignFutureStructI32>
...
internal typealias UniffiForeignFutureStructI32UniffiByValue = CValue<ziplib.cinterop.UniffiForeignFutureStructI32>
fun UniffiForeignFutureStructI32UniffiByValue(
    `returnValue`: Int,
    `callStatus`: UniffiRustCallStatusByValue,
): UniffiForeignFutureStructI32UniffiByValue {
    return cValue<ziplib.cinterop.UniffiForeignFutureStructI32> {
        this.`returnValue` = `returnValue`
        `callStatus`.write(this.`callStatus`.rawPtr)
    }
}
...
internal typealias UniffiForeignFutureCompleteI32 = ziplib.cinterop.UniffiForeignFutureCompleteI32
internal typealias UniffiForeignFutureStructU64 = CPointer<ziplib.cinterop.UniffiForeignFutureStructU64>
...
internal typealias UniffiForeignFutureStructU64UniffiByValue = CValue<ziplib.cinterop.UniffiForeignFutureStructU64>
fun UniffiForeignFutureStructU64UniffiByValue(
    `returnValue`: Long,
    `callStatus`: UniffiRustCallStatusByValue,
): UniffiForeignFutureStructU64UniffiByValue {
    return cValue<ziplib.cinterop.UniffiForeignFutureStructU64> {
        this.`returnValue` = `returnValue`
        `callStatus`.write(this.`callStatus`.rawPtr)
    }
}
...
internal typealias UniffiForeignFutureCompleteU64 = ziplib.cinterop.UniffiForeignFutureCompleteU64
internal typealias UniffiForeignFutureStructI64 = CPointer<ziplib.cinterop.UniffiForeignFutureStructI64>
...
internal typealias UniffiForeignFutureStructI64UniffiByValue = CValue<ziplib.cinterop.UniffiForeignFutureStructI64>
fun UniffiForeignFutureStructI64UniffiByValue(
    `returnValue`: Long,
    `callStatus`: UniffiRustCallStatusByValue,
): UniffiForeignFutureStructI64UniffiByValue {
    return cValue<ziplib.cinterop.UniffiForeignFutureStructI64> {
        this.`returnValue` = `returnValue`
        `callStatus`.write(this.`callStatus`.rawPtr)
    }
}
...
internal typealias UniffiForeignFutureCompleteI64 = ziplib.cinterop.UniffiForeignFutureCompleteI64
internal typealias UniffiForeignFutureStructF32 = CPointer<ziplib.cinterop.UniffiForeignFutureStructF32>
...
internal typealias UniffiForeignFutureStructF32UniffiByValue = CValue<ziplib.cinterop.UniffiForeignFutureStructF32>
fun UniffiForeignFutureStructF32UniffiByValue(
    `returnValue`: Float,
    `callStatus`: UniffiRustCallStatusByValue,
): UniffiForeignFutureStructF32UniffiByValue {
    return cValue<ziplib.cinterop.UniffiForeignFutureStructF32> {
        this.`returnValue` = `returnValue`
        `callStatus`.write(this.`callStatus`.rawPtr)
    }
}
...
internal typealias UniffiForeignFutureCompleteF32 = ziplib.cinterop.UniffiForeignFutureCompleteF32
internal typealias UniffiForeignFutureStructF64 = CPointer<ziplib.cinterop.UniffiForeignFutureStructF64>
...
internal typealias UniffiForeignFutureStructF64UniffiByValue = CValue<ziplib.cinterop.UniffiForeignFutureStructF64>
fun UniffiForeignFutureStructF64UniffiByValue(
    `returnValue`: Double,
    `callStatus`: UniffiRustCallStatusByValue,
): UniffiForeignFutureStructF64UniffiByValue {
    return cValue<ziplib.cinterop.UniffiForeignFutureStructF64> {
        this.`returnValue` = `returnValue`
        `callStatus`.write(this.`callStatus`.rawPtr)
    }
}
...
internal typealias UniffiForeignFutureCompleteF64 = ziplib.cinterop.UniffiForeignFutureCompleteF64
internal typealias UniffiForeignFutureStructPointer = CPointer<ziplib.cinterop.UniffiForeignFutureStructPointer>
...
internal typealias UniffiForeignFutureStructPointerUniffiByValue = CValue<ziplib.cinterop.UniffiForeignFutureStructPointer>
fun UniffiForeignFutureStructPointerUniffiByValue(
    `returnValue`: Pointer?,
    `callStatus`: UniffiRustCallStatusByValue,
): UniffiForeignFutureStructPointerUniffiByValue {
    return cValue<ziplib.cinterop.UniffiForeignFutureStructPointer> {
        this.`returnValue` = `returnValue`
        `callStatus`.write(this.`callStatus`.rawPtr)
    }
}
...
internal typealias UniffiForeignFutureCompletePointer = ziplib.cinterop.UniffiForeignFutureCompletePointer
internal typealias UniffiForeignFutureStructRustBuffer = CPointer<ziplib.cinterop.UniffiForeignFutureStructRustBuffer>
...
internal typealias UniffiForeignFutureStructRustBufferUniffiByValue = CValue<ziplib.cinterop.UniffiForeignFutureStructRustBuffer>
fun UniffiForeignFutureStructRustBufferUniffiByValue(
    ...
    return cValue<ziplib.cinterop.UniffiForeignFutureStructRustBuffer> {
...
internal typealias UniffiForeignFutureCompleteRustBuffer = ziplib.cinterop.UniffiForeignFutureCompleteRustBuffer
internal typealias UniffiForeignFutureStructVoid = CPointer<ziplib.cinterop.UniffiForeignFutureStructVoid>
...
internal typealias UniffiForeignFutureStructVoidUniffiByValue = CValue<ziplib.cinterop.UniffiForeignFutureStructVoid>
fun UniffiForeignFutureStructVoidUniffiByValue(
    `callStatus`: UniffiRustCallStatusByValue,
): UniffiForeignFutureStructVoidUniffiByValue {
    return cValue<ziplib.cinterop.UniffiForeignFutureStructVoid> {
        `callStatus`.write(this.`callStatus`.rawPtr)
    }
}
...
internal typealias UniffiForeignFutureCompleteVoid = ziplib.cinterop.UniffiForeignFutureCompleteVoid
...
internal interface UniffiLib {
    ...
    fun uniffi_ziplib_fn_func_decompress(
        `zipFilePath`: RustBufferByValue,
        `destPath`: RustBufferByValue,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Long
    fun ffi_ziplib_rustbuffer_alloc(
        `size`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): RustBufferByValue
    fun ffi_ziplib_rustbuffer_from_bytes(
        `bytes`: ForeignBytesByValue,
        uniffiCallStatus: UniffiRustCallStatus,
    ): RustBufferByValue
    fun ffi_ziplib_rustbuffer_free(
        `buf`: RustBufferByValue,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Unit
    fun ffi_ziplib_rustbuffer_reserve(
        `buf`: RustBufferByValue,
        `additional`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): RustBufferByValue
    fun ffi_ziplib_rust_future_poll_u8(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_cancel_u8(
        `handle`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_free_u8(
        `handle`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_complete_u8(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Byte
    fun ffi_ziplib_rust_future_poll_i8(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_cancel_i8(
        `handle`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_free_i8(
        `handle`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_complete_i8(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Byte
    fun ffi_ziplib_rust_future_poll_u16(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_cancel_u16(
        `handle`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_free_u16(
        `handle`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_complete_u16(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Short
    fun ffi_ziplib_rust_future_poll_i16(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_cancel_i16(
        `handle`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_free_i16(
        `handle`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_complete_i16(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Short
    fun ffi_ziplib_rust_future_poll_u32(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_cancel_u32(
        `handle`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_free_u32(
        `handle`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_complete_u32(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Int
    fun ffi_ziplib_rust_future_poll_i32(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_cancel_i32(
        `handle`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_free_i32(
        `handle`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_complete_i32(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Int
    fun ffi_ziplib_rust_future_poll_u64(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_cancel_u64(
        `handle`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_free_u64(
        `handle`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_complete_u64(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Long
    fun ffi_ziplib_rust_future_poll_i64(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_cancel_i64(
        `handle`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_free_i64(
        `handle`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_complete_i64(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Long
    fun ffi_ziplib_rust_future_poll_f32(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_cancel_f32(
        `handle`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_free_f32(
        `handle`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_complete_f32(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Float
    fun ffi_ziplib_rust_future_poll_f64(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_cancel_f64(
        `handle`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_free_f64(
        `handle`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_complete_f64(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Double
    fun ffi_ziplib_rust_future_poll_pointer(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_cancel_pointer(
        `handle`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_free_pointer(
        `handle`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_complete_pointer(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Pointer?
    fun ffi_ziplib_rust_future_poll_rust_buffer(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_cancel_rust_buffer(
        `handle`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_free_rust_buffer(
        `handle`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_complete_rust_buffer(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): RustBufferByValue
    fun ffi_ziplib_rust_future_poll_void(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_cancel_void(
        `handle`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_free_void(
        `handle`: Long,
    ): Unit
    fun ffi_ziplib_rust_future_complete_void(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Unit
    fun uniffi_ziplib_checksum_func_decompress(
    ): Short
    fun ffi_ziplib_uniffi_contract_version(
    ): Int
    
}

internal class UniffiLibInstance: UniffiLib {
    override fun uniffi_ziplib_fn_func_decompress(
        `zipFilePath`: RustBufferByValue,
        `destPath`: RustBufferByValue,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Long = ziplib.cinterop.uniffi_ziplib_fn_func_decompress(
        `zipFilePath`,
        `destPath`,
        uniffiCallStatus,
    )
    override fun ffi_ziplib_rustbuffer_alloc(
        `size`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): RustBufferByValue = ziplib.cinterop.ffi_ziplib_rustbuffer_alloc(
        `size`,
        uniffiCallStatus,
    )
    override fun ffi_ziplib_rustbuffer_from_bytes(
        `bytes`: ForeignBytesByValue,
        uniffiCallStatus: UniffiRustCallStatus,
    ): RustBufferByValue = ziplib.cinterop.ffi_ziplib_rustbuffer_from_bytes(
        `bytes`,
        uniffiCallStatus,
    )
    override fun ffi_ziplib_rustbuffer_free(
        `buf`: RustBufferByValue,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Unit = ziplib.cinterop.ffi_ziplib_rustbuffer_free(
        `buf`,
        uniffiCallStatus,
    )
    override fun ffi_ziplib_rustbuffer_reserve(
        `buf`: RustBufferByValue,
        `additional`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): RustBufferByValue = ziplib.cinterop.ffi_ziplib_rustbuffer_reserve(
        `buf`,
        `additional`,
        uniffiCallStatus,
    )
    override fun ffi_ziplib_rust_future_poll_u8(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_poll_u8(
        `handle`,
        `callback`,
        `callbackData`,
    )
    override fun ffi_ziplib_rust_future_cancel_u8(
        `handle`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_cancel_u8(
        `handle`,
    )
    override fun ffi_ziplib_rust_future_free_u8(
        `handle`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_free_u8(
        `handle`,
    )
    override fun ffi_ziplib_rust_future_complete_u8(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Byte = ziplib.cinterop.ffi_ziplib_rust_future_complete_u8(
        `handle`,
        uniffiCallStatus,
    )
    override fun ffi_ziplib_rust_future_poll_i8(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_poll_i8(
        `handle`,
        `callback`,
        `callbackData`,
    )
    override fun ffi_ziplib_rust_future_cancel_i8(
        `handle`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_cancel_i8(
        `handle`,
    )
    override fun ffi_ziplib_rust_future_free_i8(
        `handle`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_free_i8(
        `handle`,
    )
    override fun ffi_ziplib_rust_future_complete_i8(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Byte = ziplib.cinterop.ffi_ziplib_rust_future_complete_i8(
        `handle`,
        uniffiCallStatus,
    )
    override fun ffi_ziplib_rust_future_poll_u16(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_poll_u16(
        `handle`,
        `callback`,
        `callbackData`,
    )
    override fun ffi_ziplib_rust_future_cancel_u16(
        `handle`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_cancel_u16(
        `handle`,
    )
    override fun ffi_ziplib_rust_future_free_u16(
        `handle`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_free_u16(
        `handle`,
    )
    override fun ffi_ziplib_rust_future_complete_u16(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Short = ziplib.cinterop.ffi_ziplib_rust_future_complete_u16(
        `handle`,
        uniffiCallStatus,
    )
    override fun ffi_ziplib_rust_future_poll_i16(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_poll_i16(
        `handle`,
        `callback`,
        `callbackData`,
    )
    override fun ffi_ziplib_rust_future_cancel_i16(
        `handle`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_cancel_i16(
        `handle`,
    )
    override fun ffi_ziplib_rust_future_free_i16(
        `handle`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_free_i16(
        `handle`,
    )
    override fun ffi_ziplib_rust_future_complete_i16(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Short = ziplib.cinterop.ffi_ziplib_rust_future_complete_i16(
        `handle`,
        uniffiCallStatus,
    )
    override fun ffi_ziplib_rust_future_poll_u32(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_poll_u32(
        `handle`,
        `callback`,
        `callbackData`,
    )
    override fun ffi_ziplib_rust_future_cancel_u32(
        `handle`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_cancel_u32(
        `handle`,
    )
    override fun ffi_ziplib_rust_future_free_u32(
        `handle`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_free_u32(
        `handle`,
    )
    override fun ffi_ziplib_rust_future_complete_u32(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Int = ziplib.cinterop.ffi_ziplib_rust_future_complete_u32(
        `handle`,
        uniffiCallStatus,
    )
    override fun ffi_ziplib_rust_future_poll_i32(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_poll_i32(
        `handle`,
        `callback`,
        `callbackData`,
    )
    override fun ffi_ziplib_rust_future_cancel_i32(
        `handle`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_cancel_i32(
        `handle`,
    )
    override fun ffi_ziplib_rust_future_free_i32(
        `handle`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_free_i32(
        `handle`,
    )
    override fun ffi_ziplib_rust_future_complete_i32(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Int = ziplib.cinterop.ffi_ziplib_rust_future_complete_i32(
        `handle`,
        uniffiCallStatus,
    )
    override fun ffi_ziplib_rust_future_poll_u64(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_poll_u64(
        `handle`,
        `callback`,
        `callbackData`,
    )
    override fun ffi_ziplib_rust_future_cancel_u64(
        `handle`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_cancel_u64(
        `handle`,
    )
    override fun ffi_ziplib_rust_future_free_u64(
        `handle`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_free_u64(
        `handle`,
    )
    override fun ffi_ziplib_rust_future_complete_u64(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Long = ziplib.cinterop.ffi_ziplib_rust_future_complete_u64(
        `handle`,
        uniffiCallStatus,
    )
    override fun ffi_ziplib_rust_future_poll_i64(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_poll_i64(
        `handle`,
        `callback`,
        `callbackData`,
    )
    override fun ffi_ziplib_rust_future_cancel_i64(
        `handle`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_cancel_i64(
        `handle`,
    )
    override fun ffi_ziplib_rust_future_free_i64(
        `handle`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_free_i64(
        `handle`,
    )
    override fun ffi_ziplib_rust_future_complete_i64(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Long = ziplib.cinterop.ffi_ziplib_rust_future_complete_i64(
        `handle`,
        uniffiCallStatus,
    )
    override fun ffi_ziplib_rust_future_poll_f32(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_poll_f32(
        `handle`,
        `callback`,
        `callbackData`,
    )
    override fun ffi_ziplib_rust_future_cancel_f32(
        `handle`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_cancel_f32(
        `handle`,
    )
    override fun ffi_ziplib_rust_future_free_f32(
        `handle`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_free_f32(
        `handle`,
    )
    override fun ffi_ziplib_rust_future_complete_f32(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Float = ziplib.cinterop.ffi_ziplib_rust_future_complete_f32(
        `handle`,
        uniffiCallStatus,
    )
    override fun ffi_ziplib_rust_future_poll_f64(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_poll_f64(
        `handle`,
        `callback`,
        `callbackData`,
    )
    override fun ffi_ziplib_rust_future_cancel_f64(
        `handle`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_cancel_f64(
        `handle`,
    )
    override fun ffi_ziplib_rust_future_free_f64(
        `handle`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_free_f64(
        `handle`,
    )
    override fun ffi_ziplib_rust_future_complete_f64(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Double = ziplib.cinterop.ffi_ziplib_rust_future_complete_f64(
        `handle`,
        uniffiCallStatus,
    )
    override fun ffi_ziplib_rust_future_poll_pointer(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_poll_pointer(
        `handle`,
        `callback`,
        `callbackData`,
    )
    override fun ffi_ziplib_rust_future_cancel_pointer(
        `handle`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_cancel_pointer(
        `handle`,
    )
    override fun ffi_ziplib_rust_future_free_pointer(
        `handle`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_free_pointer(
        `handle`,
    )
    override fun ffi_ziplib_rust_future_complete_pointer(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Pointer? = ziplib.cinterop.ffi_ziplib_rust_future_complete_pointer(
        `handle`,
        uniffiCallStatus,
    )
    override fun ffi_ziplib_rust_future_poll_rust_buffer(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_poll_rust_buffer(
        `handle`,
        `callback`,
        `callbackData`,
    )
    override fun ffi_ziplib_rust_future_cancel_rust_buffer(
        `handle`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_cancel_rust_buffer(
        `handle`,
    )
    override fun ffi_ziplib_rust_future_free_rust_buffer(
        `handle`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_free_rust_buffer(
        `handle`,
    )
    override fun ffi_ziplib_rust_future_complete_rust_buffer(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): RustBufferByValue = ziplib.cinterop.ffi_ziplib_rust_future_complete_rust_buffer(
        `handle`,
        uniffiCallStatus,
    )
    override fun ffi_ziplib_rust_future_poll_void(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_poll_void(
        `handle`,
        `callback`,
        `callbackData`,
    )
    override fun ffi_ziplib_rust_future_cancel_void(
        `handle`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_cancel_void(
        `handle`,
    )
    override fun ffi_ziplib_rust_future_free_void(
        `handle`: Long,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_free_void(
        `handle`,
    )
    override fun ffi_ziplib_rust_future_complete_void(
        `handle`: Long,
        uniffiCallStatus: UniffiRustCallStatus,
    ): Unit = ziplib.cinterop.ffi_ziplib_rust_future_complete_void(
        `handle`,
        uniffiCallStatus,
    )
    override fun uniffi_ziplib_checksum_func_decompress(
    ): Short = ziplib.cinterop.uniffi_ziplib_checksum_func_decompress(
    )
    override fun ffi_ziplib_uniffi_contract_version(
    ): Int = ziplib.cinterop.ffi_ziplib_uniffi_contract_version(
    )
...
actual fun `decompress`(`zipFilePath`: kotlin.String, `destPath`: kotlin.String): kotlin.ULong {
    return FfiConverterULong.lift(uniffiRustCall { uniffiRustCallStatus ->
        UniffiLib.INSTANCE.uniffi_ziplib_fn_func_decompress(
            FfiConverterString.lower(`zipFilePath`),

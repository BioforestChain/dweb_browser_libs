...
internal interface UniffiLib : Library {
    companion object {
        internal val INSTANCE: UniffiLib by lazy {
            loadIndirect<UniffiLib>(componentName = "mix_compression")
                .also { lib: UniffiLib ->
...
private fun uniffiCheckContractApiVersion(lib: UniffiLib) {
    ...
    val scaffolding_contract_version = lib.ffi_mix_compression_uniffi_contract_version()
...
private fun uniffiCheckApiChecksums(lib: UniffiLib) {
    if (lib.uniffi_mix_compression_checksum_func_zstd_compress() != 41099.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_mix_compression_checksum_func_zstd_decompress() != 33366.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
}

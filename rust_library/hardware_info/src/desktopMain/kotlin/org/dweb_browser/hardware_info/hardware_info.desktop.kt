...
internal interface UniffiLib : Library {
    companion object {
        internal val INSTANCE: UniffiLib by lazy {
            loadIndirect<UniffiLib>(componentName = "hardware_info")
                .also { lib: UniffiLib ->
...
object FfiConverterTypeWinHardwareInfoData: FfiConverterRustBuffer<WinHardwareInfoData> {
    override fun read(buf: ByteBuffer): WinHardwareInfoData {
    ...
    override fun write(value: WinHardwareInfoData, buf: ByteBuffer) {
